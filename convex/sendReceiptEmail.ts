...
<body style="margin:0;padding:0;background:#f0f0f0;font-family:Arial,sans-serif;">
  <div style="max-width:560px;margin:32px auto;background:#ffffff;border-radius:12px;overflow:hidden;box-shadow:0 4px 20px rgba(0,0,0,0.12);">
    ...
    <div style="background:#1a1a2e;padding:28px 24px;text-align:center;box-sizing:border-box;">
      <div style="width:60px;height:60px;border-radius:50%;background:#ffffff;margin:0 auto 12px;line-height:60px;font-size:28px;font-weight:900;color:#1a1a2e;">M</div>
      <h1 style="margin:0;color:#ffffff;font-size:22px;font-weight:700;letter-spacing:1px;text-align:center;">Manna Palace</h1>
    ...
    <div style="background:#f8f8f8;padding:16px 24px;text-align:center;border-top:1px solid #eee;">
      <p style="margin:0;color:#888;font-size:11px;">This is an automated receipt from Manna Palace Cafeteria</p>
