...
const ALT_XPRINTER_VIDS: [(u16, u16); 5] = [
    ...
    (0x1A86, 0x7523), // XP-58C (CH340 USB-serial chip)
];
...
pub fn test_printer() -> Result<PrintResult, String> {
    ...
    test_data.extend_from_slice(b"--------------------------------\n");
    test_data.extend_from_slice(b"Manna Palace POS\n");
    test_data.extend_from_slice(b"XP-58C Connected\n");
    test_data.extend_from_slice(b"--------------------------------\n");
    test_data.extend_from_slice(b"\n");
