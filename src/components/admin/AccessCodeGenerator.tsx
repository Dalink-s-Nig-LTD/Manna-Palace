...
export function AccessCodeGenerator({
  ...
  const updateShift = useMutation(api.accessCodes.updateCodeShift);
                ...
                {codes.map((code) => (
                  <TableRow key={code._id}>
                    ...
                    <TableCell>
                      {isSuperadmin ? (
                        <Select
                          value={code.shift || "morning"}
                          onValueChange={(v) =>
                            handleUpdateShift(
                              code._id as Id<"accessCodes">,
                              v as "morning" | "afternoon" | "evening",
                            )
                          }
                        >
            ...
            <div className="space-y-4 py-4">
              <div className="space-y-2">
                ...
                <Select
                  value={shift}
                  onValueChange={(v) =>
                    setShift(v as "morning" | "afternoon" | "evening")
                  }
                >
                  <SelectTrigger>
                    <SelectValue />
                  ...
                  <SelectContent>
                    {(!enabledShifts || enabledShifts.includes("morning")) && (
                    ...
                    {(!enabledShifts || enabledShifts.includes("evening")) && (
