...
<div class="page front">
  <div class="front-watermark">Manna Palace</div>
...
<div class="page back">
  ...
  <div class="back-right">
    <div class="back-watermark">Manna Palace</div>
    <div>
      <div class="back-name">${student.firstName} ${student.lastName}</div>
      <div class="back-sub">Manna Palace VIP</div>
    </div>
    <div class="info-row">
    ...
    <div class="back-footer">Manna Palace</div>
  </div>
</div>
</body>
</html>`;
