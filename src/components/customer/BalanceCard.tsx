...
export function BalanceCard({ customer }: BalanceCardProps) {
  return (
    <div className="relative w-full">
      {/* Shadow card with faded blue color */}
      <div
        className="absolute inset-0 rounded-2xl bg-gradient-to-br from-blue-400 via-blue-500 to-blue-600 opacity-50 transform rotate-2 translate-y-2 translate-x-2"
        style={{ zIndex: 0 }}
      />
      ...
      >
        <div className="bg-gradient-to-br from-blue-600 via-blue-700 to-blue-900 p-6 text-white relative">
          {/* Shiny gloss overlay */}
          <div
            className="absolute inset-0 pointer-events-none"
            style={{
              background:
                "linear-gradient(135deg, rgba(255,255,255,0.25) 0%, rgba(255,255,255,0.06) 40%, transparent 60%, rgba(255,255,255,0.08) 100%)",
            }}
          />
          <div
