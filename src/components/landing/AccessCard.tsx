...
export function AccessCard({ type, onSuccess }: AccessCardProps) {
  ...
  return (
    <Card
      ...
      ${isCashier ? "bg-gradient-to-br from-primary to-navy-dark" : "bg-gradient-to-br from-accent to-blue-dark"}
    `}
    >
      {/* Decorative circles */}
      ...
      <CardContent className="relative z-10 p-6 min-h-[240px] flex flex-col justify-between">
        <div>
          <div
            className={`
