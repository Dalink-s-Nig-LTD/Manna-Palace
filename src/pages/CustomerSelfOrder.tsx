    ...
    if (e.key === "Enter" && barcodeInput.trim()) {
      if (!hasValidPrefix) {
        toast({
          ...
          description: "Please scan a valid customer barcode.",
          variant: "destructive",
        });
      }
    }
          ...
          <div className="flex flex-col items-center justify-center min-h-[55vh] gap-8">
            <div className="text-center space-y-2">
              ...
              <p className="text-muted-foreground max-w-md">
                Scan your unique barcode or enter it manually to start ordering.
              </p>
            </div>
            <Input
              ref={inputRef}
              ...
              placeholder="Scan or type barcode (e.g. CUST-20260216-ABC123)"
